...
func pluralize(numBikes:Int) {
    
    if numBikes < 1 {
        print("There are zero bicycles")
    } else if numBikes == 1 {
        print("There is \(numBikes) bicycle.")
    } else {
        print("There are \(numBikes) bicycles.")
    }
...
func pluralizedString(numBikes: Int) -> String {
    
    var statement:String = ""
    
    if numBikes < 1 {
        statement = "There are zero bicycles."
    } else if numBikes == 1 {
        statement = "There is \(numBikes) bicycle."
    } else {
        statement = "There are \(numBikes) bicycles."
    }
    return statement
}
...
//:
func pluralizedWord(singNoun:String, pluralNoun:String, count:Int) -> String {
    var statement = ""
    if count < 1 {
        statement = "There are zero \(pluralNoun)."
    } else if count == 1 {
        statement = "There is \(count) \(singNoun)."
    } else {
        statement = "There are \(count) \(pluralNoun)."
    }
...
var test1 = pluralizedWord("octopus", pluralNoun: "octopi", count: 1)
var test2 = pluralizedWord("woman", pluralNoun: "women", count: 2)
var test3 = pluralizedWord("apple", pluralNoun: "apples", count: 0)
